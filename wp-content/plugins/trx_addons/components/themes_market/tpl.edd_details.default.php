...
// Marketplace
?><section class="downloads_page_section downloads_page_types"><?php
	// Title
	?><h4 class="downloads_page_section_title"><?php esc_html_e('Marketplace', 'trx_addons'); ?></h4><?php
	// Data
	?><div class="downloads_page_features_list">
		<?php trx_addons_show_layout(trx_addons_get_post_terms('', get_the_ID(), TRX_ADDONS_EDD_TAXONOMY_MARKET)); ?>
	</div>
</section><?php
...
?><section class="downloads_page_section downloads_page_tags"><?php
	...
	?><div class="downloads_page_data">
		<?php trx_addons_show_layout(trx_addons_get_post_terms(', ', get_the_ID(), TRX_ADDONS_EDD_TAXONOMY_TAG)); ?>
	</div>
</section><?php
