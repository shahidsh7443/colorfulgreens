...
if ( !function_exists( 'greenthumb_vc_get_css' ) ) {
	add_filter( 'greenthumb_filter_get_css', 'greenthumb_vc_get_css', 10, 4 );
	function greenthumb_vc_get_css($css, $colors, $fonts, $scheme='') {
