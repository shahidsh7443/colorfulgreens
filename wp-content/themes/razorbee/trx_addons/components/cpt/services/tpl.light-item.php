...
?>">
	...
	<div class="sc_services_item_info">
		...
		<?php
			if (!empty($meta['price'])) {
					?><div class="sc_services_item_price"><?php echo $meta['price']; ?></div><?php
				}
		?>		
		<?php if (!isset($args['hide_excerpt']) || $args['hide_excerpt']==0) { ?>
			<div class="sc_services_item_content"><?php the_excerpt(); ?></div>
			<div class="sc_services_item_button sc_item_button"><a href="<?php echo esc_url($link); ?>" class="sc_button"><?php esc_html_e('Learn more', 'greenthumb'); ?></a></div>
		<?php } ?>
	</div>
</div>
<?php
